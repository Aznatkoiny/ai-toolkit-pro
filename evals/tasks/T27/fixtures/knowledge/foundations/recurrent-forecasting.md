...
sources:
  - id: nb-recurrent-forecasting
    resource: ../deep-learning-with-python/chapter10_dl-for-timeseries.ipynb
    title: "chapter10_dl-for-timeseries.ipynb"
    author: F. Chollet
    last_modified: 2021-10-03
  - id: dlwp2e-ch10
    resource: "../deep-learning-with-python/Deep_Learning_with_Python_Second_Editio (1).epub#OEBPS/Text/10.htm"
