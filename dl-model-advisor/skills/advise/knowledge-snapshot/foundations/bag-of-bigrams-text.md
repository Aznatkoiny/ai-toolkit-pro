...
sources:
  - id: nb-bag-of-bigrams-text
    resource: ../deep-learning-with-python/chapter11_part01_introduction.ipynb
    title: "chapter11_part01_introduction.ipynb"
    author: F. Chollet
    last_modified: 2021-10-03
  - id: dlwp2e-ch11
    resource: "../deep-learning-with-python/Deep_Learning_with_Python_Second_Editio (1).epub#OEBPS/Text/11.htm"
